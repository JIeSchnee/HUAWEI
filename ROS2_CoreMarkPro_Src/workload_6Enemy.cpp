...
public:
    Load6(): Node("core_test")
    {
         ...
         timer_ = this->create_wall_timer(std::chrono::microseconds(2000000), std::bind(&Load6::timerCallback, this));
         outputFile_.open("core_Enemy.csv");
...
private:
    ...
    void timerCallback()
    {
        ...
        if (outputFile_.is_open()) {
            ...
            std::cout << "Metrics saved in " << "core_Enemy.csv" << std::endl;
        } else {
