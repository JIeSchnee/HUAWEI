...
public:
    Load4(): Node("radix_test")
    {
         ...
         timer_ = this->create_wall_timer(std::chrono::microseconds(25000), std::bind(&Load4::timerCallback, this));
         outputFile_.open("radix_Enemy.csv");
...
private:
    ...
    void timerCallback()
    {
        ...
        if (outputFile_.is_open()) {
            ...
            std::cout << "Metrics saved in " << "radix_Enemy.csv" << std::endl;
        } else {
