...
{
public:
    Load8(): Node("parser_test")
    {
         RCLCPP_INFO(this->get_logger(), "START ** ");

         timer_ = this->create_wall_timer(std::chrono::microseconds(500000), std::bind(&Load8::timerCallback, this));
         outputFile_.open("parser_Enemy.csv");
...
private:
    ...
    void timerCallback()
    {
        ...
        if (outputFile_.is_open()) {
            ...
            std::cout << "Metrics saved in " << "parser_Enemy.csv" << std::endl;
        } else {
