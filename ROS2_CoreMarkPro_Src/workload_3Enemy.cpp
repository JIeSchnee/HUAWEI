...
public:
    Load3(): Node("loops_test")
    {
         ...
         timer_ = this->create_wall_timer(std::chrono::microseconds(2000000), std::bind(&Load3::timerCallback, this));
         outputFile_.open("loops_Enemy.csv");
...
private:
    ...
    void timerCallback()
    {
        ...
        if (outputFile_.is_open()) {
            ...
            std::cout << "Metrics saved in " << "loops_Enemy.csv" << std::endl;
        } else {
