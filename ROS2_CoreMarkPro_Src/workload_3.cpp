...
public:
    Load3(): Node("loops_test")
    {
         ...
         timer_ = this->create_wall_timer(std::chrono::microseconds(150000), std::bind(&Load3::timerCallback, this));
         outputFile_.open("loops_PMC.csv");
...
private:
    ...
    void timerCallback()
    {
        ...
        if (outputFile_.is_open()) {
            ...
            std::cout << "Metrics saved in " << "loops_PMC.csv" << std::endl;
        } else {
