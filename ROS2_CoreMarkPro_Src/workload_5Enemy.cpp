...
public:
    Load5(): Node("zip_test")
    {
         ...
         timer_ = this->create_wall_timer(std::chrono::microseconds(1000000), std::bind(&Load5::timerCallback, this));
         outputFile_.open("zip_Enemy.csv");
...
private:
    ...
    void timerCallback()
    {
        ...
        if (outputFile_.is_open()) {
            ...
            std::cout << "Metrics saved in " << "zip_Enemy.csv" << std::endl;
        } else {
