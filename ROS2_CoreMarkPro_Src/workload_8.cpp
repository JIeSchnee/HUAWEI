...
public:
    Load8(): Node("parser_test")
    {
         ...
         timer_ = this->create_wall_timer(std::chrono::microseconds(50000), std::bind(&Load8::timerCallback, this));
         outputFile_.open("parser_PMC.csv");
...
private:
    ...
    void timerCallback()
    {
        ...
        if (outputFile_.is_open()) {
            ...
            std::cout << "Metrics saved in " << "parser_PMC.csv" << std::endl;
        } else {
