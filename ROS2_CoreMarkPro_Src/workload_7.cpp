...
public:
    Load7(): Node("sha_test")
    {
         ...
         timer_ = this->create_wall_timer(std::chrono::microseconds(10000), std::bind(&Load7::timerCallback, this));
         outputFile_.open("sha_PMC.csv");
...
private:
    void timerCallback()
    {
        ...
        if (outputFile_.is_open()) {
            ...
            std::cout << "Metrics saved in " << "sha_PMC.csv" << std::endl;
        } else {
